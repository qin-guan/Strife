...
namespace Strife.Configuration.Database
{
    ...
    public class StrifeApiAuthorizationDbContext<TUser, TRole, TKey> : IdentityDbContext<TUser, TRole, TKey>, IPersistedGrantDbContext
        ...
        where TKey : IEquatable<TKey>
    {
        ...
        public StrifeApiAuthorizationDbContext(
